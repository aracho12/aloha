...
class Cohp(MSONable):
    """ COHP object """
    def __init__(self, efermi, energies, cohp, icohp=None, data_label=None, icohp_fermi=None):
        self.efermi = efermi
...
class Cohpout:
    ...
    def pcohp(self, label=None, orbital=None, summed_spin=True, sort_by=None, index=None, symbol=None):
        pcohp={}
